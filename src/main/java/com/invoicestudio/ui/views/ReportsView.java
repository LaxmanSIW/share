...
public class ReportsView extends BorderPane {
    ...
    // Tab 2 controls
    private ComboBox<Buyer> statementBuyerCombo;
    ...
    public void selectBuyerStatement(String buyerId) {
        ...
        if (statementBuyerCombo != null && buyerId != null) {
            for (Buyer b : statementBuyerCombo.getItems()) {
                if (buyerId.equalsIgnoreCase(b.getId())) {
                    statementBuyerCombo.setValue(b);
                    break;
                }
            }
        }
    ...
    // =========================================================================
    private Node buildOutstandingReport() {
        ...
        cAction.setCellFactory(col -> new TableCell<>() {
            private final Button btn = UiTheme.smallBtn("Statement ↗");
            {
                btn.setOnAction(e -> {
                    ...
                    if (r != null) selectBuyerStatement(r.buyerId);
                });
            }
        ...
        table.setOnMouseClicked(e -> {
            if (e.getClickCount() == 2) {
                ...
                if (sel != null) selectBuyerStatement(sel.buyerId);
            }
        });
    ...
    // =========================================================================
    private Node buildBuyerStatementReport() {
        VBox root = new VBox(14);
        root.setPadding(new Insets(14, 0, 0, 0));
        ...
        statementBuyerCombo = new ComboBox<>();
    ...
    // =========================================================================
    private Node buildTrouserMovementReport() {
        VBox root = new VBox(14);
        root.setPadding(new Insets(14, 0, 0, 0));
    ...
    // =========================================================================
    private Node buildSalesTrendsReport() {
        VBox root = new VBox(14);
        root.setPadding(new Insets(14, 0, 0, 0));
    ...
    // =========================================================================
    private Node buildItemMovementReport() {
        return buildItemAnalytics(false);
    }

    private Node buildItemPerformanceReport() {
    ...
    // =========================================================================
    private Node buildCategoryBreakdownReport() {
        VBox root = new VBox(14);
        root.setPadding(new Insets(14, 0, 0, 0));
    ...
    // =========================================================================
    private Node buildGstTaxReport() {
        VBox root = new VBox(14);
        root.setPadding(new Insets(14, 0, 0, 0));
    ...
    // =========================================================================
    private Node buildTransportPerformanceReport() {
        VBox root = new VBox(14);
        root.setPadding(new Insets(14, 0, 0, 0));
