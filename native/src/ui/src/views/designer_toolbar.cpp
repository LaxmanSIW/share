...
DesignerToolbar::DesignerToolbar(QWidget* parent) : QToolBar(parent) {
  ...
  auto* hand = addAction(IconHelper::icon(IconHelper::ICON_TOOL_HAND ? IconHelper::ICON_TOOL_HAND : IconHelper::ICON_EXPAND, 16, QColor("#94A3B8")), "Pan");
  ...
  auto* rect = addAction(IconHelper::icon(IconHelper::ICON_RECT, 16, QColor("#94A3B8")), "Rectangle");
  rect->setToolTip("Add rectangle (R)");
  connect(rect, &QAction::triggered, this, &DesignerToolbar::tool_rectangle);

  auto* ell = addAction(IconHelper::icon(IconHelper::ICON_ELLIPSE, 16, QColor("#94A3B8")), "Ellipse");
