...
QObject::connect(export_pdf_btn, &QPushButton::clicked, dlg, [dlg]() {
...
QObject::connect(add_btn, &QPushButton::clicked, dlg, [dlg, name, list]() {
...
QObject::connect(browse_btn, &QPushButton::clicked, dlg, [csv_file]() {
...
QObject::connect(print_btn, &QPushButton::clicked, dlg, [dlg]() {
