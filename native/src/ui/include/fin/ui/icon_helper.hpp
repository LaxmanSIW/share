...
class IconHelper {
 public:
  ...
  static constexpr const char* ICON_RECT        = "shapes";
  static constexpr const char* ICON_ELLIPSE     = "shapes";
  static constexpr const char* ICON_LINE_H      = "shapes";
  static constexpr const char* ICON_LINE_V      = "shapes";
  static constexpr const char* ICON_TOOL_HAND   = "expand";
  static constexpr const char* ICON_MEDIA_IMAGE = "items";
